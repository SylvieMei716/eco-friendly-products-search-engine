...
RELEVANCE_TRAIN_PATH = DATA_PATH + 'hw2_relevance.train.csv'
...
# NETWORK_STATS_PATH = CACHE_PATH + 'network_stats_ps2.csv'
...
class SearchEngine(BaseSearchEngine):
    def __init__(self,
        ...
        # )
        # self.main_index.save(MAIN_INDEX)
